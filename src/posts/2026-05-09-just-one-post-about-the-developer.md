---
title: "Just ONE post about the developer"
postType: origins
date: 2026-05-09
order: 1
published: false
...
My short career-attention-span has made this next bit take multiple paragraphs. (Inhales deeply). I started in film and television, [made this short film](https://www.youtube.com/watch?v=Et0A0BHMl4M).  Found I had more of a knack for writing books, did that for a while (my own scifi plus ghostwriting anything else for work). [These are the ones that made it to the internet.](https://www.amazon.com/stores/Tim-Attewell/author/B00ZYZX0XK?ccs_id=0f09ad06-92c7-405e-93b9-3190602ff2a8) I still ghostwrite from time to time.
...
Wrapped up in all of that are the obsessions I wouldn't call "productive." Building the perfect fleet in [Elite Dangerous](https://store.steampowered.com/app/359320/Elite_Dangerous/). Trying to move my apartment off the power grid using $0. Crafting a multiverse in Minecraft with my sister.
...
<figure>
  <img src="/assets/posts/2026-05-09-just-one-post-about-the-developer/jt-free-boardgame.png" alt="An overhead view of the JT Free board game laid out on a virtual tabletop, showing a city map board with red and blue territory lines, dozens of resource tokens in pink and yellow, character cards along the edges, and a row of player ability cards across the bottom.">
  <figcaption>JT Free, in Tabletop Simulator. A love-letter board game for friends.</figcaption>
</figure>

## A love letter to a few things

Like I said, the game is a love letter to a few things. I spent a milli-forever as a kid playing a top-down shooter called [Tyrian](https://www.gog.com/game/tyrian_2000). Flashing forward a couple of decades, you can imagine I also went nuts for games like Elite Dangerous. Ship design, customization, optimization were always huge for me. But so is co-op play with friends, and games like Elite Dangerous aren't approachable, and definitely aren't for everyone. I'm striving for Syntherion to be the best of both worlds.
...
<div class="embed-spotify">
  <iframe src="https://open.spotify.com/embed/track/4tLmcvOBzG4jyd4LA8n1ey?utm_source=generator" width="100%" height="152" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
</div>
...
<div class="embed-spotify">
  <iframe src="https://open.spotify.com/embed/playlist/43zDCnJT0BqzUPEja9TjsW?utm_source=generator" width="100%" height="352" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
</div>

## Help me shape this thing

When my focus is on writing my own sci-fi books or building board games, as much as I enjoy building them, my favorite part is always playtesting and feedback sessions with friends. I'd like to emulate that process with a larger community for Syntherion. I never thought I'd be bold enough to launch my own public Discord server, but there it is. [I hope you'll join and help me shape this thing.]({{ site.social.discordInvite }})
