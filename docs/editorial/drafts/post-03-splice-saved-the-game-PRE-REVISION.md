...
This was within the first week of the idea of the game. I remembered [those Mario Paint videos](https://www.youtube.com/watch?v=AbO1YtoUqM8&list=PL4IZq7fxXgMp702qe0LVqBXcG_12P6G7t) and thought, everyone will want to do this for their ships.

The night I got that tool working was one of the saddest of development, and almost killed the game.

I had heard and imagined amazing synthwave music in my head, and what I had just made was going to put work on players to compose utterly discordant garbage that they were forced to hear on repeat. I briefly thought, "Maybe I need to be a musician first," but put that aside because it was too far a leap from what my life currently was.
...
It was a total dream. Loops, or what I didn't realize was called a DAW until much later, could be set to a unified BPM and a unified key.

The dream was back alive, and I moved so fast to pick, upload, and implement this beautiful music that I now find myself imagining conversations with people where they say, "Why did you choose 120 BPM and the key of D-sharp minor?" to which, instead of having an answer of creative intention, I'll just have to say, "idk I was like crazy excited."
